// <copyright file="GetDocumentsSharedWithUserQuery.cs" company="Documentally">
...
public record GetDocumentsSharedWithUserQuery(long UserId) : IQuery<List<DocumentResult>>;
